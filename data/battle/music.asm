BattleMusic_Trainers:
	dbw WILL,             MUSIC_JOHTO_GYM_LEADER_BATTLE
	dbw KOGA,             MUSIC_JOHTO_GYM_LEADER_BATTLE
	dbw BRUNO,            MUSIC_JOHTO_GYM_LEADER_BATTLE
	dbw KAREN,            MUSIC_JOHTO_GYM_LEADER_BATTLE
	dbw CHAMPION,         MUSIC_CHAMPION_BATTLE
	dbw RED,              MUSIC_CHAMPION_BATTLE
	dbw LEAF,             MUSIC_CHAMPION_BATTLE
